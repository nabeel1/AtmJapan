...
<div class="col-sm-10">
<h1 class="text-center " style="color:#333333;  margin-top:-60px;"> Delete Car </h1> 
<div class="well" style="border:solid ; border-color:rgb(3, 60, 115); margin-top:15px;">

  <form action="deletevehicleprocess.php" method="post" enctype="multipart/form-data" role="form" >
 <div class="row">
...
<input id="name" name="stockno" type="text"  style="width:200px" required />
</div>
...
<input id="saveButton" type="submit" class="btn btn-primary" style="width:100px" value="Delete" />
