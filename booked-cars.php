...
<div class="col-sm-10">
<h1 class="text-center " style="color:#333333;  margin-top:-60px;"> Booked Cars </h1> 
...
echo('<td><a href="carview.php?id='.$row['productstockno'].'">View Details</a></td>');
echo('<td><a href="deletebookings.php?id='.$row['productstockno'].'">Delete</a></td>');
echo'</tr>';
}
?>
